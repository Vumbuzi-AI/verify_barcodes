...
#
#     PHX_SERVER=true bin/verify_barcodes start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :verify_barcodes, VerifyBarcodesWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :verify_barcodes, VerifyBarcodes.Repo,
    # ssl: true,
    url: database_url,
  ...
  config :verify_barcodes, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :verify_barcodes, VerifyBarcodes.Mailer,
